module Smeagol
  ...
  ##
  # StaticServer is a Rack-based server useful for previewing sites locally.
  ...
  # So this light-weight server is provided to facilitate this.
  #
  # NOTE: We would be just as happy to depend on `thin` instead of rolling our
  # own, but it lacks any ability to default directory requests to `index.html`
  # files. Ugh.
  #
  class StaticServer
